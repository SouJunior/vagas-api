...
export class InitialSchema1753987121418 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tb_candidacies_status_enum" AS ENUM('em andamento', 'encerrada', 'sem interesse')`);
        await queryRunner.query(`CREATE TABLE "tb_candidacies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "job_id" uuid NOT NULL, "user_id" uuid NOT NULL, "status" "public"."tb_candidacies_status_enum" NOT NULL, "date_candidacy" date NOT NULL DEFAULT now(), "date_closing" TIMESTAMP, CONSTRAINT "PK_f5e4bb83a197a0f6928fa214e0a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tb_alerts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "keyword" character varying NOT NULL, "location" character varying NOT NULL, CONSTRAINT "PK_ea5655784b6006b18343c398457" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tb_candidacies" ADD CONSTRAINT "FK_1662288d1b8caf94c572bfabbc6" FOREIGN KEY ("user_id") REFERENCES "tb_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "tb_candidacies" ADD CONSTRAINT "FK_5c4eb146c25019655e75d6c1e58" FOREIGN KEY ("job_id") REFERENCES "tb_jobs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tb_candidacies" DROP CONSTRAINT "FK_5c4eb146c25019655e75d6c1e58"`);
        await queryRunner.query(`ALTER TABLE "tb_candidacies" DROP CONSTRAINT "FK_1662288d1b8caf94c572bfabbc6"`);
