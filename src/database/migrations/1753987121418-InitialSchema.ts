...
export class InitialSchema1753987121418 implements MigrationInterface {
  name = 'InitialSchema1753987121418';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."tb_courses_type_enum" AS ENUM('GRADUATION', 'TECHNICAL', 'CAPACITY', 'FREE')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tb_courses_duration_enum" AS ENUM('FAST', 'MEDIUM', 'LONG')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tb_courses_status_enum" AS ENUM('COMPLETED', 'ONGOING', 'LOCKED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tb_saved_jobs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "savedAt" TIMESTAMP NOT NULL DEFAULT now(), "expiresAt" TIMESTAMP NOT NULL, "userId" uuid NOT NULL, "jobId" uuid, CONSTRAINT "PK_b69821433d55c7266698911ead6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3845b06bfda63ccc1da359b378" ON "tb_saved_jobs" ("userId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_9bbd9a1f3bb4942f0471816b11" ON "tb_saved_jobs" ("jobId") `,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tb_jobs_type_enum" AS ENUM('ANALYST', 'JUNIOR', 'TRAINEE', 'INTERNSHIP')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tb_jobs_typecontract_enum" AS ENUM('CLT', 'PJ', 'OTHER')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tb_jobs_modality_enum" AS ENUM('HYBRID', 'ON_SITE', 'REMOTE')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tb_jobs_affirmativetype_enum" AS ENUM('BLACK_BROWN_PERSON', 'CIS_TRANS_WOMEN', 'LGBTQIA+', 'SIXTY_PLUS', 'PWD')`,
    );
    await queryRunner.query(
      `CREATE TABLE "tb_jobs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" character varying NOT NULL, "prerequisites" character varying NOT NULL, "benefits" character varying, "type" "public"."tb_jobs_type_enum" NOT NULL DEFAULT 'JUNIOR', "typeContract" "public"."tb_jobs_typecontract_enum" DEFAULT 'CLT', "salaryMin" integer, "salaryMax" integer, "modality" "public"."tb_jobs_modality_enum" NOT NULL DEFAULT 'REMOTE', "federalUnit" character varying, "city" character varying, "openEndedContract" boolean NOT NULL DEFAULT true, "contractType" character varying, "contractText" character varying, "affirmative" boolean NOT NULL DEFAULT true, "affirmativeType" "public"."tb_jobs_affirmativetype_enum", "company_id" uuid NOT NULL, "status" character varying NOT NULL DEFAULT 'ACTIVE', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "content" character varying, CONSTRAINT "PK_2b2b4dc1cd0ce22fb558b7aa77c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tb_applications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "job_id" uuid NOT NULL, "user_id" uuid NOT NULL, "curriculum_id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8c067f709c944b9014b3cef3fde" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tb_candidacies_status_enum" AS ENUM('em andamento', 'encerrada', 'sem interesse')`,
    );
    await queryRunner.query(
      `CREATE TABLE "tb_candidacies" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "job_id" uuid NOT NULL, "user_id" uuid NOT NULL, "status" "public"."tb_candidacies_status_enum" NOT NULL, "date_candidacy" date NOT NULL DEFAULT now(), "date_closing" TIMESTAMP, CONSTRAINT "PK_f5e4bb83a197a0f6928fa214e0a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."tb_users_type_enum" AS ENUM('ADMIN', 'USER')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "tb_reports" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "job_id" uuid NOT NULL, "user_id" uuid NOT NULL, "description" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_b7e3c9dcb7829f13b9ae7805b03" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "tb_alerts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "keyword" character varying NOT NULL, "location" character varying NOT NULL, CONSTRAINT "PK_ea5655784b6006b18343c398457" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_certifications" ADD CONSTRAINT "FK_75f15015611ef7f444ae3fade23" FOREIGN KEY ("personal_data_id") REFERENCES "tb_personal_data"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_courses" ADD CONSTRAINT "FK_beb3c749f9d5000af64c4442989" FOREIGN KEY ("personal_data_id") REFERENCES "tb_personal_data"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_languages" ADD CONSTRAINT "FK_ecd946bdf16c31509a966a5002f" FOREIGN KEY ("personal_data_id") REFERENCES "tb_personal_data"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_work_experiences" ADD CONSTRAINT "FK_e668e3b05cc240131e27a41e5b5" FOREIGN KEY ("personal_data_id") REFERENCES "tb_personal_data"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_curriculum" ADD CONSTRAINT "FK_2c53580e4d1f616f6ffee74ba51" FOREIGN KEY ("user_id") REFERENCES "tb_users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_comments" ADD CONSTRAINT "FK_b7d6e83dbfa5e98148529803894" FOREIGN KEY ("user_id") REFERENCES "tb_users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_comments" ADD CONSTRAINT "FK_d4e57c6e48ba93300dc02734659" FOREIGN KEY ("job_id") REFERENCES "tb_jobs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tb_applications" ADD CONSTRAINT "FK_1408b5e5220c7d0fe25573cb3b9" FOREIGN KEY ("job_id") REFERENCES "tb_jobs"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_applications" ADD CONSTRAINT "FK_08c82d5bde7b75b17f54460adda" FOREIGN KEY ("user_id") REFERENCES "tb_users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tb_reports" ADD CONSTRAINT "FK_c95aa2c975cb6369772d5f15c7d" FOREIGN KEY ("job_id") REFERENCES "tb_jobs"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_reports" ADD CONSTRAINT "FK_86d265112a095a1daae2e34d669" FOREIGN KEY ("user_id") REFERENCES "tb_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_alerts" ADD CONSTRAINT "FK_a60dd357707a39803ce4cfbd90b" FOREIGN KEY ("user_id") REFERENCES "tb_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tb_alerts" DROP CONSTRAINT "FK_a60dd357707a39803ce4cfbd90b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_reports" DROP CONSTRAINT "FK_86d265112a095a1daae2e34d669"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_reports" DROP CONSTRAINT "FK_c95aa2c975cb6369772d5f15c7d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_users" DROP CONSTRAINT "FK_0afe3b230cbd95a08c72f9df3f0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_candidacies" DROP CONSTRAINT "FK_5c4eb146c25019655e75d6c1e58"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_candidacies" DROP CONSTRAINT "FK_1662288d1b8caf94c572bfabbc6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_applications" DROP CONSTRAINT "FK_f3502a850c1b2b75a5dbe2c04ee"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_applications" DROP CONSTRAINT "FK_08c82d5bde7b75b17f54460adda"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_applications" DROP CONSTRAINT "FK_1408b5e5220c7d0fe25573cb3b9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_jobs" DROP CONSTRAINT "FK_a64a855331c54d698baddb03b6f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_saved_jobs" DROP CONSTRAINT "FK_9bbd9a1f3bb4942f0471816b111"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_saved_jobs" DROP CONSTRAINT "FK_3845b06bfda63ccc1da359b378a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_comments" DROP CONSTRAINT "FK_d4e57c6e48ba93300dc02734659"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_comments" DROP CONSTRAINT "FK_b7d6e83dbfa5e98148529803894"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_curriculum" DROP CONSTRAINT "FK_2c53580e4d1f616f6ffee74ba51"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_work_experiences" DROP CONSTRAINT "FK_e668e3b05cc240131e27a41e5b5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_languages" DROP CONSTRAINT "FK_ecd946bdf16c31509a966a5002f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_courses" DROP CONSTRAINT "FK_beb3c749f9d5000af64c4442989"`,
    );
    await queryRunner.query(
      `ALTER TABLE "tb_certifications" DROP CONSTRAINT "FK_75f15015611ef7f444ae3fade23"`,
    );
    await queryRunner.query(`DROP TABLE "tb_alerts"`);
    ...
    await queryRunner.query(`DROP TABLE "tb_candidacies"`);
    await queryRunner.query(`DROP TYPE "public"."tb_candidacies_status_enum"`);
    await queryRunner.query(`DROP TABLE "tb_applications"`);
    await queryRunner.query(`DROP TABLE "tb_jobs"`);
    await queryRunner.query(
      `DROP TYPE "public"."tb_jobs_affirmativetype_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9bbd9a1f3bb4942f0471816b11"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_3845b06bfda63ccc1da359b378"`,
    );
    await queryRunner.query(`DROP TABLE "tb_saved_jobs"`);
    await queryRunner.query(`DROP TABLE "tb_companies"`);
    await queryRunner.query(
      `DROP TYPE "public"."tb_companies_companysize_enum"`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."tb_personal_data_gender_enum"`,
    );
